...
fTypeArgs1 = {'normal': {'type_prob': 0.5,
                        ...
                        'costparams': {'a': 2, 'b': 4}}}
fTypeArgs1.update({'rich': {'type_prob': 0.04,
...
fTypeArgs1.update({'crank': {'type_prob': 0.01,
                             'destparams': {'d0': (numpy.array([24, 24]), numpy.array([[6, 0], [0,6]])),
                                            'd1': (numpy.array([15, 40]), numpy.array([[10, 0], [0, 10]])),
                                            'd2': (numpy.array([40, 15]), numpy.array([[10, 0], [0, 10]]))},
                             'waitparams': -1,
...
fTypeArgs2 = {'normal': {'type_prob': 0.3,
                        'destparams': {'d0': (numpy.array([24, 24]), numpy.array([[6, 0], [0,6]])),
                                       'd1': (numpy.array([15, 40]), numpy.array([[10, 0], [0, 10]])),
                                       'd2': (numpy.array([40, 15]), numpy.array([[10, 0], [0, 10]]))},
                        'waitparams': {'mu': 30, 'sigma': 10},
...
fTypeArgs2.update({'random': {'type_prob': 0.02,
                             ...
                             'waitparams': {'min': 10, 'max': 60},
                             'costparams': {'min': 100, 'max': 1000}}})
fTypeArgs2.update({'crank': {'type_prob': 0.03,
                             'destparams': {'d0': (numpy.array([24, 24]), numpy.array([[6, 0], [0,6]])),
                                            'd1': (numpy.array([15, 40]), numpy.array([[10, 0], [0, 10]])),
                                            'd2': (numpy.array([40, 15]), numpy.array([[10, 0], [0, 10]]))},
                             'waitparams': -1,
...
fTypeArgs3.update({'hurry': {'type_prob': 0.2,
                            ...
                            'waitparams': {'tau': 20},
                            'costparams': {'ceiling': 50}}})
fTypeArgs3.update({'budget': {'type_prob': 0.6,
                             'destparams': {'mu': 10, 'sigma': 5},
                             'waitparams': {'mu': 50, 'sigma': 15},
                             'costparams': {'ceiling': 2}}})
...
fTypeArgs3.update({'random': {'type_prob': 0.02,
                             ...
                             'waitparams': {'min': 10, 'max': 60},
                             'costparams': {'min': 100, 'max': 1000}}})
fTypeArgs3.update({'crank': {'type_prob': 0.05,
                             'destparams': {'d0': (numpy.array([24, 24]), numpy.array([[6, 0], [0,6]])),
                                            'd1': (numpy.array([15, 40]), numpy.array([[10, 0], [0, 10]])),
                                            'd2': (numpy.array([40, 15]), numpy.array([[10, 0], [0, 10]]))},
                             'waitparams': -1,
...
fTypeArgs4 = {'normal': {'type_prob': 0.33,
                        'destparams': {'d0': (numpy.array([24, 24]), numpy.array([[6, 0], [0,6]])),
                                       'd1': (numpy.array([15, 40]), numpy.array([[10, 0], [0, 10]])),
                                       'd2': (numpy.array([40, 15]), numpy.array([[10, 0], [0, 10]]))},
                        'waitparams': {'mu': 30, 'sigma': 10},
                        'costparams': {'a': 2, 'b': 4}}}
fTypeArgs4.update({'rich': {'type_prob': 0.35,
                           'destparams': {'d0': (numpy.array([24, 24]), numpy.array([[6, 0], [0,6]]), 1.0),
                                          'd1': (numpy.array([15, 40]), numpy.array([[10, 0], [0, 10]]), 1.0),
                                          'd2': (numpy.array([40, 15]), numpy.array([[10, 0], [0, 10]]), 1.0)},
                           'waitparams': {'min': 15, 'max': 60},
                           'costparams': {'a': 2, 'b': 4, 'scale': 20}}})
fTypeArgs4.update({'hurry': {'type_prob': 0.05,
                            'destparams': {'mu': 10, 'sigma': 5},
                            'waitparams': {'tau': 20},
                            'costparams': {'ceiling': 50}}})
fTypeArgs4.update({'budget': {'type_prob': 0.05,
                             'destparams': {'mu': 10, 'sigma': 5},
                             'waitparams': {'mu': 50, 'sigma': 15},
                             'costparams': {'ceiling': 2}}})
fTypeArgs4.update({'opportune': {'type_prob': 0.1,
                                'destparams': {'d0': (numpy.array([24, 24]), numpy.array([[4, 0], [0,4]])),
                                               'd1': (numpy.array([10, 35]), numpy.array([[5, 0], [0, 5]])),
                                               'd2': (numpy.array([40, 15]), numpy.array([[5, 0], [0, 5]]))},
                                'waitparams': {'tau': 35},
                                'costparams': {'min': 1, 'max': 4}}})
fTypeArgs4.update({'random': {'type_prob': 0.02,
                             'destparams': None,
                             'waitparams': {'min': 10, 'max': 60},
                             'costparams': {'min': 100, 'max': 1000}}})
fTypeArgs4.update({'crank': {'type_prob': 0.1,
                             'destparams': {'d0': (numpy.array([24, 24]), numpy.array([[6, 0], [0,6]])),
                                            'd1': (numpy.array([15, 40]), numpy.array([[10, 0], [0, 10]])),
                                            'd2': (numpy.array([40, 15]), numpy.array([[10, 0], [0, 10]]))},
                             'waitparams': -1,
...
jct2 = networld.junctionDef(x=30, y=0, cap=2, canStop=True, src=trafficSrcMajor, sink=trafficSinkMajor, **fTypeArgs2)
jct3 = networld.junctionDef(x=49, y=0, cap=2, canStop=True, src=trafficSrcMinor, sink=trafficSinkMinor, **fTypeArgs2)
jct3A = networld.junctionDef(x=40, y=5, cap=2, canStop=True, **fTypeArgs4)
...
jct6 = networld.junctionDef(x=20, y=10, cap=2, canStop=True, maxTraffic=12, **fTypeArgs4)
jct6A = networld.junctionDef(x=30, y=10, cap=8, canStop=True, fareProb=fareProbPopular, maxTraffic=12, src=trafficSrcMajor, sink=trafficSinkDrain, **fTypeArgs4)
jct9 = networld.junctionDef(x=40, y=10, cap=4, canStop=True, fareProb=fareProbPopular, maxTraffic=12, **fTypeArgs4)
jct10 = networld.junctionDef(x=49, y=10, cap=2, canStop=True, src=trafficSrcSignificant, sink=trafficSinkSignificant, **fTypeArgs2)
jct7A = networld.junctionDef(x=15, y=15, cap=4, canStop=True, fareProb=fareProbPopular, maxTraffic=12, **fTypeArgs2)
...
jct12 = networld.junctionDef(x=20, y=20, cap=4, canStop=True, fareProb=fareProbSemiPopular, maxTraffic=12, **fTypeArgs4)
...
jct18A = networld.junctionDef(x=15, y=35, cap=4, canStop=True, fareProb=fareProbSemiPopular, maxTraffic=12, **fTypeArgs2)
